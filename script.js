	...
	$(document).on('mouseover', function(e) {
        ...
        if ($('body').hasClass('mini-sidebar') && $('#toggle_btn').is(':visible')) {
            ...
            if (targ) {
				...
				$('.logo-white').attr('style', 'display: block');
                $('.subdrop + ul').slideDown();
            } else {
                $('body').removeClass('expand-menu');
				$('.logo-white').attr('style', 'display: none !important');
                $('.subdrop + ul').slideUp();
            }
            return false;
        }
...
'<div class="sidebar-layout">' +
	...
	var customize_link_old_z = '<div class="customizer-links">' +
	...
	var customize_link = '<div class="customizer-links" style="min-height:auto;">'+
    '<ul class="sticky-sidebar">'+
        '<li class="sidebar-icons">'+
            '<a href="#" class="add-setting" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Tooltip on left">' + '<img src="assets/img/icons/sidebar-icon-02.svg" class="feather-five" alt="" />' + '</a>' +
        '</li>'+
    '</ul>'+
'</div>'+
'<div class="sidebar-settings preview-toggle">'+
    '<div class="sidebar-content sticky-sidebar-one">'+
        '<div class="sidebar-header">'+
            '<h5>Change Preview Mode</h5>'+
            '<a class="sidebar-close" href="#"><img src="assets/img/icons/close-icon.svg" alt="" /></a>'+
        '</div>'+
        '<div class="sidebar-body">'+
            '<h6 class="theme-title">Choose Here</h6>'+
            '<div class="switch-wrapper">'+
                '<div id="dark-mode-toggle">'+
                    '<span class="light-mode active"> <img src="assets/img/icons/sun-icon.svg" class="me-2" alt="" /> Light</span>' + '<span class="dark-mode"><i class="far fa-moon me-2"></i> Dark</span>'+
                '</div>'+
            '</div>'+
        '</div>'+
    '</div>'+
